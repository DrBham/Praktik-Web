<x-default-layout title="Student" section_title="Students">
    ...
    {{-- Gate untuk tombol Add Student --}}
    @can('store-student')
        <div class="flex mb-4">
            <a href="{{ route('students.create') }}">
                <div class="bg-green-50 text-green-500 border border-green-500 px-3 py-2 flex items-center gap-2">
                ...
                @forelse ($students as $student)
                    <tr class="border-b border-zinc-200 hover:bg-zinc-100">
                        ...
                        <td class="py-3 px-6 flex justify-center gap-1">
                            ...
                            {{-- Gate untuk melihat detail mahasiswa --}}
                            @can('view-student')
                            ...
                            {{-- Gate untuk mengedit data mahasiswa --}}
                            @can('edit-student')
                            ...
                            {{-- Gate untuk menghapus data mahasiswa --}}
                            @can('destroy-student')
